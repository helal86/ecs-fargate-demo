...
# Automatically scale down by one
...
# CloudWatch alarm to trigger the autoscaling up policy on CPU high
...
# CloudWatch alarm to trigger autoscaling down policy when CPU = low
